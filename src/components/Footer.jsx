            ...
            <div className="flex gap-2 mt-5">
              {[
                ...
                <a
                  key={name}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-surface-100 hover:bg-brand-50 hover:text-brand-600 flex items-center justify-center text-surface-500 text-xs font-bold transition-all duration-200"
                  title={name}
                >
                  {label}
                </a>
